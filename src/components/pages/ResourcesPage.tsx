import { BookOpen, Download, FileText, Video, TrendingUp } from 'lucide-react';
...
const resources = [
  ...
  { title: 'eBooks', description: 'In-depth marketing guides', icon: BookOpen, link: '/ebooks' },
  { title: 'Webinars', description: 'Live training sessions', icon: Video, link: '/webinars' },
  { title: 'Free Tools', description: 'Marketing calculators & analyzers', icon: TrendingUp, link: '/tools' },
