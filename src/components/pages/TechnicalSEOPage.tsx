import { Code, TrendingUp, Zap, Shield, Award, CheckCircle2, ArrowRight, ChevronRight } from 'lucide-react';
import { Link } from 'react-router';
import { BentoGrid2 } from '../layout/BentoGrid2';
import { Breadcrumbs } from '../ui/Breadcrumbs';
import { SEOHead } from '../SEOHead';
import { StructuredData, organizationSchema, getWebPageSchema, getBreadcrumbSchema } from '../../utils/seo-system';

const coreServices = [
  { icon: TrendingUp, title: 'Site Speed Optimization', desc: 'Achieve sub-2 second load times with advanced performance optimization techniques.' },
  { icon: Zap, title: 'Mobile-First Indexing', desc: 'Ensure perfect mobile experience and Core Web Vitals compliance.' },
  { icon: Code, title: 'Schema Markup', desc: 'Implement rich snippets and structured data for enhanced search visibility.' },
  { icon: Shield, title: 'Crawl Budget Optimization', desc: 'Help search engines efficiently crawl and index your important pages.' },
  { icon: Award, title: 'HTTPS & Security', desc: 'Implement SSL, security headers, and protect against SEO vulnerabilities.' },
  { icon: CheckCircle2, title: 'Site Architecture', desc: 'Build logical URL structures, internal linking, and navigation hierarchies.' }
];

const benefits = [
  { icon: TrendingUp, title: '200% Traffic Increase', desc: 'Average organic traffic growth after technical fixes', stat: '200%' },
  { icon: TrendingUp, title: '< 2s Load Time', desc: 'Lightning-fast page speeds for better rankings', stat: '<2s' },
  { icon: Zap, title: '100% Mobile Score', desc: 'Perfect mobile experience and Core Web Vitals', stat: '100' },
  { icon: Code, title: '50% More Indexing', desc: 'More pages indexed and ranking on Google', stat: '50%' }
];
