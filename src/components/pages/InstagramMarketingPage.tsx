import { Instagram, TrendingUp, Heart, Users, Award, CheckCircle2, ArrowRight, ChevronRight } from 'lucide-react';
...
const coreServices = [
  { icon: Award, title: 'Content Creation', desc: 'Professional photos, Reels, Stories, and carousel posts that stop the scroll.' },
  { icon: TrendingUp, title: 'Instagram Ads', desc: 'High-converting Instagram ad campaigns (Feed, Stories, Reels, Explore).' },
  { icon: Users, title: 'Influencer Marketing', desc: 'Partner with relevant Instagram influencers to reach targeted audiences.' },
  { icon: Heart, title: 'Community Management', desc: 'Engage with followers, respond to DMs/comments, build loyal community.' },
  { icon: TrendingUp, title: 'Growth Strategy', desc: 'Organic growth tactics: hashtags, engagement pods, strategic following.' },
  { icon: Award, title: 'Reels & Stories', desc: 'Create viral-worthy Reels and engaging Stories for maximum reach.' }
];
...
const benefits = [
  ...
  { icon: Award, title: '70% Response Rate', desc: 'To customer DMs and comments', stat: '70%' }
];
