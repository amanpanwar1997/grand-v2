import { Users, TrendingUp, Heart, Target, Award, CheckCircle2, ArrowRight, ChevronRight, Star } from 'lucide-react';
...
const coreServices = [
  { icon: Star, title: 'Influencer Discovery', desc: 'Find the perfect influencers that match your brand values and target audience.' },
  { icon: Users, title: 'Campaign Strategy', desc: 'Design influencer campaigns that drive authentic engagement and conversions.' },
  { icon: Target, title: 'Contract Management', desc: 'Handle negotiations, contracts, and deliverable tracking professionally.' },
  { icon: Heart, title: 'Content Collaboration', desc: 'Work with influencers to create authentic, branded content that resonates.' },
  { icon: TrendingUp, title: 'Performance Tracking', desc: 'Measure reach, engagement, conversions, and ROI from influencer partnerships.' },
  { icon: Award, title: 'Brand Safety', desc: 'Vet influencers for authenticity, fake followers, and brand alignment.' }
];
