import { TrendingUp, Award, ChevronRight, ArrowUpRight, CheckCircle2 } from 'lucide-react';
...
const industries = [
  { name: 'Healthcare', icon: TrendingUp },
  { name: 'eCommerce', icon: TrendingUp },
  { name: 'Real Estate', icon: TrendingUp },
  { name: 'Education', icon: TrendingUp },
  { name: 'Technology', icon: TrendingUp },
  { name: 'Hospitality', icon: TrendingUp }
];
