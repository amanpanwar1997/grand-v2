import { Monitor, TrendingUp, Eye, Users, Award, CheckCircle2, ArrowRight, ChevronRight } from 'lucide-react';
...
const coreServices = [
  { icon: Monitor, title: 'Banner Ad Design', desc: 'Eye-catching responsive display banners optimized for all devices and placements.' },
  { icon: TrendingUp, title: 'Audience Targeting', desc: 'Reach the right people using demographics, interests, behaviors, and intent signals.' },
  { icon: Eye, title: 'Smart Remarketing', desc: 'Re-engage website visitors with personalized ads across 2M+ websites.' },
  { icon: Users, title: 'Display Network Ads', desc: 'Advertise on Google Display Network reaching 90% of internet users worldwide.' },
  { icon: Award, title: 'Dynamic Remarketing', desc: 'Show personalized product ads to shoppers who viewed but didn\'t purchase.' },
  { icon: CheckCircle2, title: 'Campaign Optimization', desc: 'Continuous A/B testing, bid adjustments, and performance improvements.' }
];
...
const benefits = [
  ...
  { icon: Award, title: '5x Better ROI', desc: 'With strategic remarketing campaigns', stat: '5x' }
];
