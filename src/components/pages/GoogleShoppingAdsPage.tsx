import { ShoppingCart, TrendingUp, DollarSign, Users, Award, CheckCircle2, ArrowRight, ChevronRight } from 'lucide-react';
...
const coreServices = [
  ...
  { icon: Award, title: 'Shopping Campaign Setup', desc: 'Create high-performing Standard and Smart Shopping campaigns with proper structure.' },
  { icon: TrendingUp, title: 'Bid Management', desc: 'Strategic bidding to maximize ROAS while staying within your budget constraints.' },
  { icon: Award, title: 'Merchant Center Setup', desc: 'Complete Google Merchant Center configuration with feed management and compliance.' },
  { icon: Award, title: 'Performance Max Campaigns', desc: 'Leverage Google\'s AI with Performance Max for shopping to reach more customers.' },
  { icon: Award, title: 'Product Review Integration', desc: 'Display star ratings and reviews to increase click-through rates by 17%.' }
];
...
const benefits = [
  ...
  { icon: Award, title: '35% Lower CPC', desc: 'Reduced cost-per-click through optimization', stat: '-35%' }
];
