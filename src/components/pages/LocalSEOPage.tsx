import { MapPin, TrendingUp, Building, Users, Award, CheckCircle2, ArrowRight, ChevronRight } from 'lucide-react';
...
const coreServices = [
  ...
  { icon: Users, title: 'Review Management', desc: 'Generate, monitor, and respond to customer reviews across all platforms.' },
  { icon: Award, title: 'Google Maps Optimization', desc: 'Rank higher in Google Maps for "near me" and local searches.' },
  { icon: CheckCircle2, title: 'Local Link Building', desc: 'Earn authoritative local backlinks from Indore businesses and directories.' }
];
...
const benefits = [
  ...
  { icon: ArrowRight, title: '400% More Calls', desc: 'Increase in direct phone call inquiries', stat: '400%' }
];
